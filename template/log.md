...
- **Work sessions:** [WORK_LOG.md](WORK_LOG.md) — detailed session log
- **Architectural decisions:** [_decisions.md](_decisions.md) — ADR log
- **Template updates:** [_meta.md](_meta.md) — when template was updated
